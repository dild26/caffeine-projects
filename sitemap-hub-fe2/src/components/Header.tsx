        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${isActive('search')
                  ? 'bg-primary/10 text-primary'
                  : 'text-muted-foreground hover:text-foreground'
                }`}
            >
            ...
            {isAuthenticated && (
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${isActive('dashboard')
                    ? 'bg-primary/10 text-primary'
                    : 'text-muted-foreground hover:text-foreground'
                  }`}
              >
