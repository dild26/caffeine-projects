...
import { UserProfile, UserRole, BusinessRole } from '@/backend';
...
export default function ProfileSetupModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const profile: UserProfile = {
      ...
      role: UserRole.user,
      businessRole: BusinessRole.viewer,
      tenantId: 'default',
    };
  ...
  return (
    <Dialog open={true}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-center">Welcome to SitemapHub</DialogTitle>
