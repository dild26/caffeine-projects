              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {adminSettings && (
                  <div className="p-4 bg-accent/10 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">₹{Number(adminSettings.subscriptionFee).toLocaleString()}</p>
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-lg border border-border/50">
                  ...
                  <Badge variant={subscription.status === 'active' ? 'default' : subscription.status === 'paused' ? 'secondary' : 'outline'}>
                    {subscription.status}
                  </Badge>
                </div>
