...
import { useShareSelectedPages, useGetAllSecoinfiAppsEntries, useAddSecoinfiAppEntry, useUpdateSecoinfiAppEntry, useDeleteSecoinfiAppEntry, useBulkDeleteSecoinfiAppEntries } from '@/hooks/useQueries';
