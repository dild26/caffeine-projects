...
import { useGetCallerUserRole, useGetAllFieldDefinitions, useCreateFieldDefinition, 
         ...
         useIsStripeConfigured } from '@/hooks/useQueries';
    ...
    if (summary && backendFields) {
      ...
      const defaultFields: EditableField[] = [
        ...
        },
        {
          ...
          type: 'textarea',
          value: 'sitemapAi is the brain-child of Dileep Kumar D, CEO at Sudha Enterprises/SECOINFI',
          placeholder: 'sitemapAi is the brain-child of Dileep Kumar D, CEO at Sudha Enterprises/SECOINFI',
