            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  ...
                  <li>Public access to Dashboard, IPNet pages, and content pages</li>
                </ul>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-2 flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Complete dashboard with URL Generator, Domains, Grid Generator, Leaderboard, Fixtures, and Analytics tabs. No login required.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-2 flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isAuthenticated 
                          ? "✓ You are logged in. Access subject to subscription verification." 
                    ...
                    >
                      {isAuthenticated ? "Access Now" : "Learn More"}
                    </Button>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Badge variant="default">Public Access</Badge>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-muted-foreground">IPNet Pages</p>
                  <Badge variant="default">Public Access</Badge>
                </div>
                <div className="space-y-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                ...
                <Button variant="outline" onClick={() => navigate({ to: '/sitemap' })}>
                  Sitemap
                </Button>
                <Button variant="outline" onClick={() => navigate({ to: '/IPNet/ipcams' })}>
                  IPNet Camera Grid
                </Button>
                {isAuthenticated && (
                  <>
