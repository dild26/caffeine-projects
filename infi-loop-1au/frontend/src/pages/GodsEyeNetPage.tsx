...
import { Loader2, Lock, ShieldAlert, Eye, Clock, DollarSign, CheckCircle2, AlertTriangle } from 'lucide-react';
import { toast } from 'sonner';

export default function GodsEyeNetPage() {
  ...
  // Apply security protections when content is visible
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="border-destructive">
          <CardHeader>
            ...
            <CardDescription>
              This content requires admin privileges or verified subscription with active payment.
            </CardDescription>
          </CardHeader>
  ...
  // Show content with security protections
  return (
    <div className="h-screen w-screen overflow-hidden bg-background">
      ...
      <div className="absolute top-0 left-0 right-0 z-50 bg-destructive/10 border-b border-destructive/20 px-4 py-2">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-semibold text-destructive">Protected Content</span>
      ...
      <div className="h-full w-full pt-12">
        <iframe
          ...
          title="God's Eye Net - Protected Content"
